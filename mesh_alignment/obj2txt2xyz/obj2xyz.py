...
def export_xyz_file(output_folder, file_name, point_cloud):
    output_path = os.path.join(output_folder, f"{file_name}.xyz")
...
if __name__ == '__main__':
    ...
    output_folder = os.path.join(script_directory, "xyz_output")
    ...
    print("Point clouds exported to XYZ files in the output folder.")
