...
def move_to_point_clouds_folder():
    ...
    point_clouds_folder = os.path.join(current_directory, "point clouds FRDS")
...
def move_to_other_meshes_folder_i():
    current_directory = os.getcwd()
    test_folder = os.path.join(current_directory, "source")
    point_clouds_folder = os.path.join(current_directory, "other meshes FRDS")
...
def main():
    ...
    results_folder = os.path.join(current_directory, f"results FRDS {current_date}")
    if not os.path.exists(results_folder):
        os.makedirs(results_folder)
        

    # Create a new file to store the copied data inside "results" directory
    output_file = os.path.join(results_folder, "output FRDS.txt")
    ...
    shutil.move(os.path.join(current_directory, "point clouds FRDS"), os.path.join(results_folder, "point clouds FRDS"))
    shutil.move(os.path.join(current_directory, "other meshes FRDS"), os.path.join(results_folder, "other meshes FRDS"))
